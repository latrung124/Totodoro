...
class PomodoroViewModel : public QObject
{
    ...
    Q_PROPERTY(int shortBreakTime READ shortBreakTime WRITE setShortBreakTime NOTIFY shortBreakTimeChanged)
    Q_PROPERTY(int longBreakTime READ longBreakTime WRITE setLongBreakTime NOTIFY longBreakTimeChanged)
    Q_PROPERTY(int currentState READ currentState WRITE setCurrentState NOTIFY currentStateChanged)
    Q_PROPERTY(DynamicObjectState dynamicObjectState READ getDynamicObjectState WRITE setDynamicObjectState NOTIFY dynamicObjectStateChanged)
    Q_PROPERTY(int pomodoroCompleted READ pomodoroCompleted WRITE setPomodoroCompleted NOTIFY pomodoroCompletedChanged)
    Q_PROPERTY(QString dynamicObject READ dynamicObject WRITE setDynamicObject NOTIFY dynamicObjectChanged)
