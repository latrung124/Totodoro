...
class TaskViewModel : public QObject
{
    ...
    Q_PROPERTY(int totalPomodoros READ totalPomodoros WRITE setTotalPomodoros NOTIFY totalPomodorosChanged)
    Q_PROPERTY(int completedPomodoros READ completedPomodoros WRITE setCompletedPomodoros NOTIFY completedPomodorosChanged)
    Q_PROPERTY(PriorityType priorityType READ priorityType WRITE setPriorityType NOTIFY priorityTypeChanged)
