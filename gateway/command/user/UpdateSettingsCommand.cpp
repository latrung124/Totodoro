...
UpdateSettingsCommand::UpdateSettingsCommand(const ApiClientFactoryPtr& apiClientFactory,
...
void UpdateSettingsCommand::execute()
{
    ...
    connect(mApiClient.get(), &OpenAPI::OAIUserServiceApi::userServiceUpdateSettingsSignal,
            this, &UpdateSettingsCommand::onSettingsUpdated);
    connect(mApiClient.get(), &OpenAPI::OAIUserServiceApi::userServiceUpdateSettingsSignalError,
            this, &UpdateSettingsCommand::onSettingsError);
...
void UpdateSettingsCommand::onSettingsError(const OAIUser_serviceUpdateSettingsResponse& response,
