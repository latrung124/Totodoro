...
*/
int OAIUserServiceApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
/**
    ...
    */
int OAIUserServiceApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUserServiceApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUserServiceApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
QString OAIUserServiceApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIUserServiceApi::userServiceCreateUser(const OAIUser_serviceCreateUserRequest &body) {
    QString fullPath = QString(_serverConfigs["userServiceCreateUser"][_serverIndices.value("userServiceCreateUser")].URL()+"/v1/users");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserServiceApi::userServiceCreateUserCallback);
...
void OAIUserServiceApi::userServiceGetSettings(const QString &user_id) {
    QString fullPath = QString(_serverConfigs["userServiceGetSettings"][_serverIndices.value("userServiceGetSettings")].URL()+"/v1/users/{userId}/settings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserServiceApi::userServiceGetSettingsCallback);
    connect(this, &OAIUserServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserServiceApi::userServiceGetUser(const QString &user_id) {
    QString fullPath = QString(_serverConfigs["userServiceGetUser"][_serverIndices.value("userServiceGetUser")].URL()+"/v1/users/{userId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserServiceApi::userServiceGetUserCallback);
    connect(this, &OAIUserServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserServiceApi::userServiceUpdateSettings(const QString &user_id, const OAIUserServiceUpdateSettingsBody &body) {
    QString fullPath = QString(_serverConfigs["userServiceUpdateSettings"][_serverIndices.value("userServiceUpdateSettings")].URL()+"/v1/users/{userId}/settings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserServiceApi::userServiceUpdateSettingsCallback);
    connect(this, &OAIUserServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUserServiceApi::userServiceUpdateUser(const QString &user_id, const OAIUserServiceUpdateUserBody &body) {
    QString fullPath = QString(_serverConfigs["userServiceUpdateUser"][_serverIndices.value("userServiceUpdateUser")].URL()+"/v1/users/{userId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserServiceApi::userServiceUpdateUserCallback);
    connect(this, &OAIUserServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
