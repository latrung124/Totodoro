...
public:
	 ...
	 */
	void userServiceUpdateSettings(
...
Q_SIGNALS:
	...
	void userServiceCreateUserSignalFull(
	    OAIHttpRequestWorker *worker, OAIUser_serviceCreateUserResponse summary);
	void userServiceGetSettingsSignalFull(
	    OAIHttpRequestWorker *worker, OAIUser_serviceGetSettingsResponse summary);
	void userServiceGetUserSignalFull(
	    OAIHttpRequestWorker *worker, OAIUser_serviceGetUserResponse summary);
	void userServiceUpdateSettingsSignalFull(
	    OAIHttpRequestWorker *worker, OAIUser_serviceUpdateSettingsResponse summary);
	void userServiceUpdateUserSignalFull(
	    OAIHttpRequestWorker *worker, OAIUser_serviceUpdateUserResponse summary);

	Q_DECL_DEPRECATED_X("Use userServiceCreateUserSignalError() instead")
	void userServiceCreateUserSignalE(
	    OAIUser_serviceCreateUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    QString error_str);
	void userServiceCreateUserSignalError(
	    OAIUser_serviceCreateUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceGetSettingsSignalError() instead")
	void userServiceGetSettingsSignalE(
	    OAIUser_serviceGetSettingsResponse summary,
	    QNetworkReply::NetworkError error_type,
	    QString error_str);
	void userServiceGetSettingsSignalError(
	    OAIUser_serviceGetSettingsResponse summary,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceGetUserSignalError() instead")
	void userServiceGetUserSignalE(
	    OAIUser_serviceGetUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    QString error_str);
	void userServiceGetUserSignalError(
	    OAIUser_serviceGetUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceUpdateSettingsSignalError() instead")
	void userServiceUpdateSettingsSignalE(
	    OAIUser_serviceUpdateSettingsResponse summary,
	    QNetworkReply::NetworkError error_type,
	    QString error_str);
	void userServiceUpdateSettingsSignalError(
	    OAIUser_serviceUpdateSettingsResponse summary,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceUpdateUserSignalError() instead")
	void userServiceUpdateUserSignalE(
	    OAIUser_serviceUpdateUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    QString error_str);
	void userServiceUpdateUserSignalError(
	    OAIUser_serviceUpdateUserResponse summary,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);

	Q_DECL_DEPRECATED_X("Use userServiceCreateUserSignalErrorFull() instead")
	void userServiceCreateUserSignalEFull(
	    OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
	void userServiceCreateUserSignalErrorFull(
	    OAIHttpRequestWorker *worker,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceGetSettingsSignalErrorFull() instead")
	void userServiceGetSettingsSignalEFull(
	    OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
	void userServiceGetSettingsSignalErrorFull(
	    OAIHttpRequestWorker *worker,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceGetUserSignalErrorFull() instead")
	void userServiceGetUserSignalEFull(
	    OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
	void userServiceGetUserSignalErrorFull(
	    OAIHttpRequestWorker *worker,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceUpdateSettingsSignalErrorFull() instead")
	void userServiceUpdateSettingsSignalEFull(
	    OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
	void userServiceUpdateSettingsSignalErrorFull(
	    OAIHttpRequestWorker *worker,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
	Q_DECL_DEPRECATED_X("Use userServiceUpdateUserSignalErrorFull() instead")
	void userServiceUpdateUserSignalEFull(
	    OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
	void userServiceUpdateUserSignalErrorFull(
	    OAIHttpRequestWorker *worker,
	    QNetworkReply::NetworkError error_type,
	    const QString &error_str);
