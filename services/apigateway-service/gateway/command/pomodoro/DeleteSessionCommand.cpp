...
void DeleteSessionCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceDeleteSessionSignal,
	    this,
	    &DeleteSessionCommand::onSessionDeleted);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceDeleteSessionSignalError,
	    this,
	    &DeleteSessionCommand::onSessionError);
...
void DeleteSessionCommand::onSessionError(
    const OAIPomodoro_serviceDeleteSessionResponse &summary,
