...
GetSessionByIdCommand::GetSessionByIdCommand(
    const QString &sessionId, const QString &baseUrl, QObject *parent)
    : IApiCommand(parent)
...
void GetSessionByIdCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceGetSessionByIdSignal,
	    this,
	    &GetSessionByIdCommand::onSessionRetrieved);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceGetSessionByIdSignalError,
	    this,
	    &GetSessionByIdCommand::onSessionError);
...
void GetSessionByIdCommand::onSessionRetrieved(
    const OAIPomodoro_serviceGetSessionByIdResponse &response)
{
	if (!mResponseHandler) {
...
void GetSessionByIdCommand::onSessionError(
    const OAIPomodoro_serviceGetSessionByIdResponse &summary,
