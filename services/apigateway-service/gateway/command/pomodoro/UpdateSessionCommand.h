 ...
 * @author trung.la
 * @date 09-04-2025
 * @brief Header file for UpdateSessionCommand class that handles updating Pomodoro sessions via the
 * OpenAPI client.
 */
...
public:
	...
	using OAIPomodoro_serviceUpdateSessionResponse =
	    OpenAPI::OAIPomodoro_serviceUpdateSessionResponse;
