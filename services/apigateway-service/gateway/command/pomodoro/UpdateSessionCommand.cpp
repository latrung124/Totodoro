 ...
 * @author trung.la
 * @date 09-04-2025
 * @brief Implementation of UpdateSessionCommand class that handles updating Pomodoro sessions via
 * the OpenAPI client.
 */
...
void UpdateSessionCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceUpdateSessionSignal,
	    this,
	    &UpdateSessionCommand::onSessionUpdated);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIPomodoroServiceApi::pomodoroServiceUpdateSessionSignalError,
	    this,
	    &UpdateSessionCommand::onSessionError);
...
void UpdateSessionCommand::onSessionError(
    const OAIPomodoro_serviceUpdateSessionResponse &summary,
