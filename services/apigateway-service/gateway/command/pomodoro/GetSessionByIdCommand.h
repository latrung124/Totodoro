...
public:
	using OAIPomodoro_serviceGetSessionByIdResponse =
	    OpenAPI::OAIPomodoro_serviceGetSessionByIdResponse;
	GetSessionByIdCommand(
	    const QString &sessionId, const QString &baseUrl, QObject *parent = nullptr);
