...
UpdateUserCommand::UpdateUserCommand(
    const OAIUserServiceUpdateUserBody &updateUserBody,
...
void UpdateUserCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIUserServiceApi::userServiceUpdateUserSignal,
	    this,
	    &UpdateUserCommand::onUserUpdated);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAIUserServiceApi::userServiceUpdateUserSignalError,
	    this,
	    &UpdateUserCommand::onUserError);
...
void UpdateUserCommand::onUserError(
    const OAIUser_serviceUpdateUserResponse &summary,
