 ...
 * @author trung.la
 * @date 09-18-2025
 * @brief Declaration of GetSettingsCommand class that handles fetching user settings via the
 * OpenAPI client.
 */
...
public:
	...
	GetSettingsCommand(const QString &userId, const QString &baseUrl, QObject *parent = nullptr);
