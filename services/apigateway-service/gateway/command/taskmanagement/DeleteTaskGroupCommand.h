 ...
 * @author trung.la
 * @date 09-11-2025
 * @brief Header file for DeleteTaskGroupCommand class that handles deleting a task group via the
 * OpenAPI client.
 */
...
public:
	using OAITask_managementDeleteTaskGroupResponse =
	    OpenAPI::OAITask_managementDeleteTaskGroupResponse;
	DeleteTaskGroupCommand(
	    const QString &groupId, const QString &baseUrl, QObject *parent = nullptr);
