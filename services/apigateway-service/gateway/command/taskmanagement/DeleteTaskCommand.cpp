...
DeleteTaskCommand::DeleteTaskCommand(const QString &taskId, const QString &baseUrl, QObject *parent)
    : IApiCommand(parent)
    , mDeleted(false)
    , mTaskId(taskId)
    , mBaseUrl(baseUrl)
...
void DeleteTaskCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceDeleteTaskSignal,
	    this,
	    &DeleteTaskCommand::onTaskDeleted);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceDeleteTaskSignalError,
	    this,
	    &DeleteTaskCommand::onTaskError);
...
void DeleteTaskCommand::onTaskError(
