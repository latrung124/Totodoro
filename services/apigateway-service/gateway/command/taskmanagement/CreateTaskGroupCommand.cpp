...
CreateTaskGroupCommand::CreateTaskGroupCommand(
    const OAIRequest &body, const QString &baseUrl, QObject *parent)
    : IApiCommand(parent)
    , mBody(body)
    , mBaseUrl(baseUrl)
{
...
void CreateTaskGroupCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OAITaskManagementServiceApi::taskManagementServiceCreateTaskGroupSignal,
	    this,
	    &CreateTaskGroupCommand::onCreated);
	connect(
	    mApiClient.get(),
	    &OAITaskManagementServiceApi::taskManagementServiceCreateTaskGroupSignalError,
	    this,
	    &CreateTaskGroupCommand::onError);
...
void CreateTaskGroupCommand::onError(
