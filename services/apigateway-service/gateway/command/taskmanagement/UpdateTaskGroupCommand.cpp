...
UpdateTaskGroupCommand::UpdateTaskGroupCommand(
...
void UpdateTaskGroupCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceUpdateTaskGroupSignal,
	    this,
	    &UpdateTaskGroupCommand::onTaskGroupUpdated);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceUpdateTaskGroupSignalError,
	    this,
	    &UpdateTaskGroupCommand::onTaskGroupError);
...
void UpdateTaskGroupCommand::onTaskGroupUpdated(
...
void UpdateTaskGroupCommand::onTaskGroupError(
    const OAITask_managementUpdateTaskGroupResponse &summary,
