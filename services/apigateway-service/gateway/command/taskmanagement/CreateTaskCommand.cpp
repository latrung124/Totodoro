...
CreateTaskCommand::CreateTaskCommand(
    const QString &groupId, const OAIRequest &body, const QString &baseUrl, QObject *parent)
    : IApiCommand(parent)
    , mGroupId(groupId)
    , mBody(body)
    , mBaseUrl(baseUrl)
...
void CreateTaskCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OAITaskManagementServiceApi::taskManagementServiceCreateTaskSignal,
	    this,
	    &CreateTaskCommand::onCreated);
	connect(
	    mApiClient.get(),
	    &OAITaskManagementServiceApi::taskManagementServiceCreateTaskSignalError,
	    this,
	    &CreateTaskCommand::onError);
...
void CreateTaskCommand::onError(
