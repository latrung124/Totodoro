 ...
 * @author trung.la
 * @date 09-11-2025
 * @brief Header file for GetTaskGroupsCommand class that handles retrieving task groups via the
 * OpenAPI client.
 */
...
public:
	...
	GetTaskGroupsCommand(const QString &userId, const QString &baseUrl, QObject *parent = nullptr);
