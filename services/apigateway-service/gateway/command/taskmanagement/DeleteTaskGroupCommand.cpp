...
DeleteTaskGroupCommand::DeleteTaskGroupCommand(
    const QString &groupId, const QString &baseUrl, QObject *parent)
    : IApiCommand(parent)
    , mDeleted(false)
    , mGroupId(groupId)
    , mBaseUrl(baseUrl)
...
void DeleteTaskGroupCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceDeleteTaskGroupSignal,
	    this,
	    &DeleteTaskGroupCommand::onTaskGroupDeleted);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceDeleteTaskGroupSignalError,
	    this,
	    &DeleteTaskGroupCommand::onTaskGroupError);
...
void DeleteTaskGroupCommand::onTaskGroupDeleted(
    const OAITask_managementDeleteTaskGroupResponse &response)
{
	if (!mResponseHandler) {
...
void DeleteTaskGroupCommand::onTaskGroupError(
    const OAITask_managementDeleteTaskGroupResponse &summary,
