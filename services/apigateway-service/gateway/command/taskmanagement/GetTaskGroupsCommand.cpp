...
GetTaskGroupsCommand::GetTaskGroupsCommand(
...
void GetTaskGroupsCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceGetTaskGroupsSignal,
	    this,
	    &GetTaskGroupsCommand::onTaskGroupsRetrieved);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceGetTaskGroupsSignalError,
	    this,
	    &GetTaskGroupsCommand::onTaskGroupsError);
...
void GetTaskGroupsCommand::onTaskGroupsError(
