...
void UpdateTaskCommand::execute()
{
	...
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceUpdateTaskSignal,
	    this,
	    &UpdateTaskCommand::onTaskUpdated);
	connect(
	    mApiClient.get(),
	    &OpenAPI::OAITaskManagementServiceApi::taskManagementServiceUpdateTaskSignalError,
	    this,
	    &UpdateTaskCommand::onTaskError);
...
void UpdateTaskCommand::onTaskError(
    const OAITask_managementUpdateTaskResponse &response,
