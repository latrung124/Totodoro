...
bool UserApiGatewayManager::registerResponseCallback(
...
void UserApiGatewayManager::request(const gateway::ApiRequest &request)
{
...
bool UserApiGatewayManager::updateUserSettings(const gateway::UserSettings &userSettings)
{
	...
	auto command = factory.createTyped<UpdateSettingsCommand>(
	    OpenAPI::OAIUserServiceUpdateSettingsBody(
	        QString::fromStdString(userSettings.toJsonString())),
