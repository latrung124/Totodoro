...
TaskManagementRouteHandler::TaskManagementRouteHandler(
    AsyncRequestProcessorPtr requestProcessor, const std::string &baseUrl)
{
...
std::string TaskManagementRouteHandler::extractPathParam(
    const httplib::Request &req, size_t index) const
{
	std::smatch matches;
	for (const auto &route : mRoutePatterns) {
...
void TaskManagementRouteHandler::handleCreateTaskGroup(
...
void TaskManagementRouteHandler::handleGetTaskGroups(
    const httplib::Request &req, httplib::Response &res)
{
...
void TaskManagementRouteHandler::handleUpdateTaskGroup(
    const httplib::Request &req, httplib::Response &res)
{
	...
	auto command = std::make_shared<UpdateTaskGroupCommand>(
	    body, groupId, QString::fromStdString(mBaseUrl));
	auto responseHandler = createResponseHandler();
	command->setResponseHandler(responseHandler);
...
void TaskManagementRouteHandler::handleDeleteTaskGroup(
    const httplib::Request &req, httplib::Response &res)
{
	const QString groupId = QString::fromStdString(extractPathParam(req, 1));
	if (groupId.isEmpty()) {
	...
	auto command = std::make_shared<DeleteTaskGroupCommand>(
	    groupId, QString::fromStdString(mBaseUrl));
	auto responseHandler = createResponseHandler();
	command->setResponseHandler(responseHandler);
...
void TaskManagementRouteHandler::handleCreateTask(
    const httplib::Request &req, httplib::Response &res)
{
	...
	auto command = std::make_shared<CreateTaskCommand>(
	    groupId, body, QString::fromStdString(mBaseUrl));
	auto responseHandler = createResponseHandler();
	command->setResponseHandler(responseHandler);
...
void TaskManagementRouteHandler::handleGetTasks(const httplib::Request &req, httplib::Response &res)
{
	...
	auto command = std::make_shared<GetTasksCommand>(
	    userId, groupId, QString::fromStdString(mBaseUrl));
	auto responseHandler = createResponseHandler();
	command->setResponseHandler(responseHandler);
...
void TaskManagementRouteHandler::handleUpdateTask(
    const httplib::Request &req, httplib::Response &res)
{
	...
	auto command = std::make_shared<UpdateTaskCommand>(
	    body, taskId, QString::fromStdString(mBaseUrl));
	auto responseHandler = createResponseHandler();
	command->setResponseHandler(responseHandler);
...
void TaskManagementRouteHandler::handleDeleteTask(
    const httplib::Request &req, httplib::Response &res)
{
