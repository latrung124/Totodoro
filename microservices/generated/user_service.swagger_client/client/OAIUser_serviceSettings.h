...
#ifndef OAIUser_serviceSettings_H
#define OAIUser_serviceSettings_H
...
class OAIUser_serviceSettings : public OAIObject {
public:
    OAIUser_serviceSettings();
    OAIUser_serviceSettings(QString json);
    ~OAIUser_serviceSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_serviceSettings)

#endif // OAIUser_serviceSettings_H
